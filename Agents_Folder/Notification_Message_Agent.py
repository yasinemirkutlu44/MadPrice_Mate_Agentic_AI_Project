import os
from Agents_Folder.Deal_Scraper import Opportunity
...
class MessagingAgent(Agent):
    ...
    def __init__(self):
        ...
        self.log("Messaging Agent has initialized Pushover and GPT-5-MINI")
    ...
    def craft_message(
        ...
        "Produce a little excitement and enthusiasm in your message to get the user interested in checking out this deal!\n\n"
